        ...
        <form action="{{ route('admin.suppliers.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('accounting_code') is-invalid @enderror" 
                               id="accounting_code" name="accounting_code" value="{{ old('accounting_code') }}" 
                    ...
                    <div class="col-md-6">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="payment_period_type" id="payment_days" 
                                   value="days" {{ old('payment_period_type') == 'days' ? 'checked' : '' }}>
                            ...
                            <div class="row mt-2">
                                <div class="col-6">
                                    ...
                                    <input type="number" class="form-control form-control-sm" 
                                           ...
                                           value="{{ old('payment_days_before', 0) }}" min="0">
                                </div>
                                <div class="col-6">
                                    ...
                                    <input type="number" class="form-control form-control-sm" 
                                           ...
                                           value="{{ old('payment_days_after', 0) }}" min="0">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="payment_period_type" id="payment_monthly" 
                                   value="monthly" {{ old('payment_period_type') == 'monthly' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-2 mb-1">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" 
                                                   ...
                                                   id="day_{{ $i }}"
                                                   {{ in_array($i, old('payment_monthly_days', [])) ? 'checked' : '' }}>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('address') is-invalid @enderror" 
                          id="address" name="address" rows="3" placeholder="Tedarikçi adresi">{{ old('address') }}</textarea>
                @error('address')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('sync_frequency') is-invalid @enderror" 
                            ...
                            <option value="daily" {{ old('sync_frequency') == 'daily' ? 'selected' : '' }}>Günlük</option>
                            <option value="weekly" {{ old('sync_frequency') == 'weekly' ? 'selected' : '' }}>Haftalık</option>
                            <option value="monthly" {{ old('sync_frequency') == 'monthly' ? 'selected' : '' }}>Aylık</option>
                        </select>
