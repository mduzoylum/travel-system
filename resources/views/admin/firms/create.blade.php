                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('payment_type') is-invalid @enderror" 
                            ...
                            <option value="credit" {{ old('payment_type', 'credit') == 'credit' ? 'selected' : '' }}>Kredili Çalışma</option>
                            <option value="credit_card" {{ old('payment_type') == 'credit_card' ? 'selected' : '' }}>Kredi Kartı ile Ödeme</option>
                        </select>
                        @error('payment_type')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
