                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('location_description') is-invalid @enderror" 
                                              id="location_description" name="location_description" rows="3">{{ old('location_description', $hotel->location_description) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('general_description') is-invalid @enderror" 
                                              id="general_description" name="general_description" rows="4">{{ old('general_description', $hotel->general_description) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('about') is-invalid @enderror" 
                                              id="about" name="about" rows="4">{{ old('about', $hotel->about) }}</textarea>
                                    @error('about')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
