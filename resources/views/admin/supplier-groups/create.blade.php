                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('group_type') is-invalid @enderror" 
                            ...
                            <option value="report" {{ old('group_type') == 'report' ? 'selected' : '' }}>Rapor Grubu</option>
                            <option value="profit" {{ old('group_type') == 'profit' ? 'selected' : '' }}>Kar Grubu</option>
                            <option value="xml" {{ old('group_type') == 'xml' ? 'selected' : '' }}>XML Tedarikçi</option>
                            <option value="manual" {{ old('group_type') == 'manual' ? 'selected' : '' }}>Manuel Tedarikçi</option>
                        </select>
