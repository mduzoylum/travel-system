...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">Yeni Kar Kuralı</h1>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('trip_type') is-invalid @enderror" id="trip_type" name="trip_type" required>
                                <option value="domestic" {{ old('trip_type') == 'domestic' ? 'selected' : '' }}>Yurtiçi</option>
                                <option value="international" {{ old('trip_type') == 'international' ? 'selected' : '' }}>Yurtdışı</option>
                            </select>
                            @error('trip_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('travel_type') is-invalid @enderror" id="travel_type" name="travel_type" required>
                                <option value="one_way" {{ old('travel_type') == 'one_way' ? 'selected' : '' }}>Tek Yön</option>
                                <option value="round_trip" {{ old('travel_type') == 'round_trip' ? 'selected' : '' }}>Gidiş-Dönüş</option>
                            </select>
                            @error('travel_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('fee_type') is-invalid @enderror" id="fee_type" name="fee_type" required>
                                ...
                                <option value="tiered" {{ old('fee_type') == 'tiered' ? 'selected' : '' }}>Katmanlı</option>
                            </select>
                            @error('fee_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('min_fee') is-invalid @enderror" 
                                   id="min_fee" name="min_fee" value="{{ old('min_fee') }}" min="0">
                            @error('min_fee')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('max_fee') is-invalid @enderror" 
                                   id="max_fee" name="max_fee" value="{{ old('max_fee') }}" min="0">
                            @error('max_fee')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
